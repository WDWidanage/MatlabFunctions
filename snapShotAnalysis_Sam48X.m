function ssResults = snapShotAnalysis_Sam48X(data,varargin)
% Extract capacity, resitances of the Samsung 48X cell.
% The data must be collected from a Digatron tester and have followed the
% Samsung 48X LTA Reference Preformance Test protocol.
%
